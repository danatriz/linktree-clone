<template>
    <div id="LinkBox" class="w-full bg-white rounded-3xl">
                ...
                <div class="flex items-center w-full">
                    ...
                    <div v-else class="flex items-center w-full">
                        <div
                            ...
                            :class="isMobile ? 'text-xt':'text-sm'"
                        >
                            TESTING
                        </div>
                        <Icon 
        ...
        <div 
            ...
            :class="[
                {'max-h-[180px] transiiton-all duration-300 ease-in': isDelete},
            ...
            >
                ...
                <div class="w-full px-4 py-3">
                    <div class="flex items-center gep-2 w-full"> 
                        <button
...
onMounted(() =>{
    ...
    document.addEventListener('mouseup', function (e){
        ...
        if(
            ...
            editNameInput.blur()
            emit('updateInput', {id: 0, str:''})
        }
    })

    document.addEventListener('mouseup', function (e){
        let editLinkInput = document.getElementById(`editNameInput-${link.value.id}`)
        if(
            editLinkInput &&
            ! editNameInput.contains(e.target) &&
...
const updatedLink = useDebounce(async () => {
